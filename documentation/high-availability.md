...
Kea is configured to run in [hot-standby mode](https://kea.readthedocs.io/en/kea-1.8.1/arm/hooks.html#hot-standby-configuration) in conjunction with a MySQL shared lease database run in [AWS RDS](https://aws.amazon.com/rds/). See [Discounted Configurations](#discounted-configurations) for more information.
